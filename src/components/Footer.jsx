        ...
        <>
            <div className="container-fluid bg-dark ">
                ...
                <div className="row  mt-5 text-center p-5">
                    <div className="col-lg-4 col-md-4 col-sm-4 text-light px-2 bg-dark justify-content-center mt-3">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-4 text-light px-4  bg-dark mt-3">
                        {/* <h3 >Contact Us</h3> */}
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-4 bg-dark px-2  mt-3">
            ...
            <div className="container-fluid bg-primary p-5">
                <div className="row">
                    ...
                    <div className="col-lg-12 col-md-12 text-center col-sm-12 mb-3">
                        <h3  >Follow us on</h3>
                    </div>
                ...
                <div className="row d-flex justify-content-center">
                    ...
                    <div className="col-lg-1 col-md-1 col-sm-1 p-2 d-flex justify-content-center">
