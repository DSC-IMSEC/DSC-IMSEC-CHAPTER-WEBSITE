...
const Event = () => {
    return (
        <>
            <div className="row d-flex flex-column my-5 mx-5 p-5">
                <div className="col-lg-10 col-sm-10 mb-3 mx-5">
                    <h1 className="display-5 text-primary">Our Events</h1>
                    <h6>Questions? Please Contact @gmail.com</h6>
                </div>
                <div className="col-lg-10 col-sm-10 mx-5 mb-5">
                    <h1 className="display-5">Our <strong className="text-primary">Features Event</strong> & <strong>Meetup</strong></h1>
            ...
            <div className="conatoiner mx-5 my-5 p-5">
                <div className="list-example1 d-flex flex-row mx-5">
                    <div id="list-example" className="list-group col-4">
